...
const textButon = 'Cambiar permisos de usuario'
...
async function testPermissions(permissionsParamOld, permissionsParamNew, userParam) {
  const uri = `http://localhost/banderas_backend/public/api/test_permissions_user`
