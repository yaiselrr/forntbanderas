...
import * as columns from './key_words.columns'
import * as validation from './key_words.validation'
import dayjs from 'dayjs'

const Parent = await RBaseModel('key_words', 'manage/key_words')
export default class Key_words extends Parent {
  id
  name
  description
  created_at
  ...
  static visible_columns = Key_words.show_columns(['*'], true)
