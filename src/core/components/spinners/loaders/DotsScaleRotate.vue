...
const props = defineProps({
  style_class: pt.arrayOf(pt.string).def(["text-primary-500"]),
  font_size: pt.string.def('4rem'),
})
defineComponent({
...
<template>
  <svg :style="'font-size:'+props.font_size" :class="props.style_class" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
    <g>
